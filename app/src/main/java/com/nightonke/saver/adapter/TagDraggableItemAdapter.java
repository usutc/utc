...
public class TagDraggableItemAdapter
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.tagImage.setImageResource(UtcCoinUtil.GetTagIcon(tags.get(position).getId()));
        holder.tagName.setText(UtcCoinUtil.GetTagName(tags.get(position).getId()));
        holder.tagName.setTypeface(UtcCoinUtil.typefaceLatoLight);
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0)) {
            ...
            if ((dragState & Draggable.STATE_FLAG_IS_ACTIVE) != 0) {
                ...
                UtcCoinUtil.clearState(holder.mContainer.getForeground());
