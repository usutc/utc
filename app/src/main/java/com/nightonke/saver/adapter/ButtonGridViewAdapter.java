...
public class ButtonGridViewAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return UtcCoinUtil.BUTTONS.length;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == 11) {
            holder.tv.setTypeface(UtcCoinUtil.typefaceLatoHairline);
            ...
            holder.tv.setTypeface(UtcCoinUtil.typefaceLatoHairline);
            holder.tv.setText(UtcCoinUtil.BUTTONS[position]);
        ...
        if (shouldChange) {
            holder.fl.setBackgroundColor(
                    UtcCoinUtil.getAlphaColor(SettingManager.getInstance().getRemindColor()));
            ...
            holder.fl.setBackgroundColor(UtcCoinUtil.getAlphaColor(UtcCoinUtil.MY_BLUE));
            holder.ml.setRippleColor(UtcCoinUtil.MY_BLUE);
            holder.iv.setColor(UtcCoinUtil.MY_BLUE);
            holder.tv.setTextColor(UtcCoinUtil.MY_BLUE);
        }
