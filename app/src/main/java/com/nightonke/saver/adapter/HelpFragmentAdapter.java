...
import com.nightonke.saver.fragment.HelpUtcCoinFragment;
...
public class HelpFragmentAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (this.position) {
            case 0: return HelpUtcCoinFragment.newInstance();
    ...
    public CharSequence getPageTitle(int position) {
        switch (this.position) {
            case 0: return UtcCoinApplication.getAppContext().getResources().getString(R.string.app_name);
            case 1: return UtcCoinApplication.getAppContext().getResources().getString(R.string.feedback);
            case 2: return UtcCoinApplication.getAppContext().getResources().getString(R.string.about);
        }
        return "";
    }
}
