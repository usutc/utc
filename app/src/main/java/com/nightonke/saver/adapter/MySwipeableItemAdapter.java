...
public class MySwipeableItemAdapter
    ...
    private List<UtcCoinRecord> records;
    ...
    public MySwipeableItemAdapter(Context inContext, List<UtcCoinRecord> records, final OnItemDeleteListener onItemDeleteListener, OnItemClickListener onItemClickListener) {
        mContext = inContext;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        UtcCoinRecord record = records.get(tPosition);
        holder.tagImage.setImageResource(
                UtcCoinUtil.GetTagIcon(record.getTag()));
        ...
        holder.money.setTextColor(ContextCompat.getColor(UtcCoinApplication.getAppContext(), R.color.my_blue));
    ...
    public static class SwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        protected void onPerformAction() {
            ...
            UtcCoinUtil.backupUtcCoinRecord
