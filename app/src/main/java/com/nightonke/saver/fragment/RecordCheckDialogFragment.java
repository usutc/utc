...
public class RecordCheckDialogFragment extends DialogFragment implements RecordCheckDialogRecyclerViewAdapter.OnItemClickListener {
    ...
    public RecordCheckDialogFragment(Context context, List<UtcCoinRecord> list, String title) {
        this.list = list;
        this.title = title;
        mContext = context;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alert.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                btnPositive.setTypeface(UtcCoinUtil.typefaceLatoLight);
            }
        });
    ...
    public void onItemClick(View view, int position) {
        ...
        dialog = new MaterialDialog.Builder(mContext)
                .icon(UtcCoinUtil.GetTagIconDrawable(list.get(position).getTag()))
        ...
        date.setText(UtcCoinUtil.GetCalendarStringRecordCheckDialog(mContext, list.get(position).getCalendar()));
    }
}
