...
public class EditMoneyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (getArguments().getInt("type") == UtcCoinFragmentManager.MAIN_ACTIVITY_FRAGMENT) {
            UtcCoinFragmentManager.mainActivityEditMoneyFragment = this;
        } else if (getArguments().getInt("type") == UtcCoinFragmentManager.EDIT_RECORD_ACTIVITY_FRAGMENT) {
            UtcCoinFragmentManager.editRecordActivityEditMoneyFragment = this;
        }
        ...
        if (getArguments().getInt("type") == UtcCoinFragmentManager.EDIT_RECORD_ACTIVITY_FRAGMENT
            ...
            UtcCoinFragmentManager.editRecordActivityEditMoneyFragment
                    .setTagImage(UtcCoinUtil.GetTagIcon(
                            (int)RecordManager.SELECTED_RECORDS.get(UtcCoinUtil.editRecordPosition).getTag()));
            UtcCoinFragmentManager.editRecordActivityEditMoneyFragment
                    .setTagName(UtcCoinUtil.GetTagName(
                            (int)RecordManager.SELECTED_RECORDS.get(UtcCoinUtil.editRecordPosition).getTag()));
            UtcCoinFragmentManager.editRecordActivityEditMoneyFragment
                    .setTagId(RecordManager.SELECTED_RECORDS.get(UtcCoinUtil.editRecordPosition).getTag());
            UtcCoinFragmentManager.editRecordActivityEditMoneyFragment
                    .setNumberText(String.format("%.0f", RecordManager.SELECTED_RECORDS.get(UtcCoinUtil.editRecordPosition).getMoney()));
        }
