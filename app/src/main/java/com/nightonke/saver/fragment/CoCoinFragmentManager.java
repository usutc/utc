 ...
 */
public class UtcCoinFragmentManager {
    ...
    private static UtcCoinFragmentManager ourInstance = new UtcCoinFragmentManager();

    public static UtcCoinFragmentManager getInstance() {
        return ourInstance;
    }

    private UtcCoinFragmentManager() {
    }
}
