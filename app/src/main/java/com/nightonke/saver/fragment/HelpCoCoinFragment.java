 ...
 */
public class HelpUtcCoinFragment extends Fragment {

    private ObservableScrollView mScrollView;

    public static HelpUtcCoinFragment newInstance() {
        HelpUtcCoinFragment fragment = new HelpUtcCoinFragment();
        return fragment;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        int width = UtcCoinUtil.getInstance().GetScreenWidth(mContext) - UtcCoinUtil.getInstance().dpToPx(20);
        ...
        textView2.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView3.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView4.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView5.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView6.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView7.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView8.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView9.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        textView10.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
