...
public class ShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int iconOffsetX = UtcCoinUtil.getInstance().dpToPx(28);
        int iconOffsetY = UtcCoinUtil.getInstance().dpToPx(28);
        ...
        ((TextView)findViewById(R.id.text_0)).setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        for (int i = 0; i < 5; ++i) {
            SliceValue sliceValue = new SliceValue((float) Math.random() * 30 + 15, ContextCompat.getColor(UtcCoinApplication.getAppContext(), R.color.white));
        ...
        for (int i = 0; i < 1; ++i) {
            ...
            aLine.setColor(ContextCompat.getColor(UtcCoinApplication.getAppContext(), R.color.white));
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            for (int j = 0; j < 1; ++j) {
                subcolumnValues.add(new SubcolumnValue((float) Math.random() * 50f + 5, ContextCompat.getColor(UtcCoinApplication.getAppContext(), R.color.white)));
            }
        ...
        sc7.startToPosition(size.x / 2 - UtcCoinUtil.getInstance().dpToPx(140), size.y * 8 / 9 - UtcCoinUtil.getInstance().dpToPx(140) + size.y);
        ...
        ((TextView)findViewById(R.id.text_1)).setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        sc9.startToPosition(size.x / 2 - UtcCoinUtil.getInstance().dpToPx(100) + size.x, size.y / 7);
        ...
        sc10.startToPosition(size.x / 2 - size.x, size.y * 6 / 7 - UtcCoinUtil.getInstance().dpToPx(100));
        ...
        ((TextView)findViewById(R.id.text_2)).setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        ...
        ((TextView)findViewById(R.id.text_3)).setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        viewPagerLayoutParams.topMargin
                                = getStatusBarHeight() + UtcCoinUtil.getToolBarHeight(mContext) / 2;
        ...
        switch (CURRENT_STATE) {
            case NEW_PASSWORD:
                if (UtcCoinUtil.ClickButtonDelete(position)) {
                    if (longClick) {
                        UtcCoinFragmentManager.passwordChangeFragment[CURRENT_STATE].init();
                        newPassword = "";
                    } else {
                        UtcCoinFragmentManager.passwordChangeFragment[CURRENT_STATE]
                    ...
                    newPassword += UtcCoinUtil.BUTTONS[position];
            ...
            case PASSWORD_AGAIN:
                if (UtcCoinUtil.ClickButtonDelete(position)) {
                    ...
                    againPassword += UtcCoinUtil.BUTTONS[position];
                        ...
                        if (againPassword.equals(newPassword)) {
                            ...
                            if (SettingManager.getInstance().getLoggenOn()) {
                                User currentUser = BmobUser.getCurrentUser(
                                        UtcCoinApplication.getAppContext(), User.class);
                            ...
                            UtcCoinFragmentManager.passwordChangeFragment[CURRENT_STATE].clear(4);
                            UtcCoinFragmentManager.passwordChangeFragment[CURRENT_STATE - 1].init();
...
//    }
    ...
    protected void onDestroy() {
        for (int i = 0; i < 3; i++) {
            UtcCoinFragmentManager.passwordChangeFragment[i].onDestroy();
            UtcCoinFragmentManager.passwordChangeFragment[i] = null;
        }
        super.onDestroy();
    }
