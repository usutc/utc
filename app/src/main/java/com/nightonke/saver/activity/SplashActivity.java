...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appName.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
        loadingText = (TextView)findViewById(R.id.loading_text);
        loadingText.setTypeface(UtcCoinUtil.getInstance().typefaceLatoLight);
    ...
    private void startCircularReveal() {
        ...
        int cx = location[0] + UtcCoinUtil.dpToPx(24);
        int cy = location[1] + UtcCoinUtil.dpToPx(24);
        ...
        animator.addListener(new SupportAnimator.AnimatorListener() {
            ...
            public void onAnimationEnd() {
                Log.d("UtcCoin", "Showing animation completed");
    ...
    public class InitData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            CrashReport.initCrashReport(UtcCoinApplication.getAppContext(), "900018935", false);
        ...
        protected void onPostExecute(String result) {
            Log.d("UtcCoin", "Loading Data completed");
