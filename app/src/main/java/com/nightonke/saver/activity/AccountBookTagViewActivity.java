...
public class AccountBookTagViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.getPagerTitleStrip().setTypeface(UtcCoinUtil.typefaceLatoLight, Typeface.NORMAL);
            ...
            mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
                ...
                public HeaderDesign getHeaderDesign(int page) {
                    return HeaderDesign.fromColorAndUrl(
                            UtcCoinUtil.GetTagColor(RecordManager.TAGS.get(page).getId()),
                            UtcCoinUtil.GetTagUrl(RecordManager.TAGS.get(page).getId()));
                }
            });
        } else {
            mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
