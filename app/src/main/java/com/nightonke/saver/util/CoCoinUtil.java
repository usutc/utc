...
// Todo make UtcCoinUtil singleton
// Todo floating labels in english

public class UtcCoinUtil {
    ...
    public static UtcCoinRecord backupUtcCoinRecord;
...
//            R.drawable.sum_header_pie
    ...
    public static void init(Context context) {
        ...
        MY_BLUE = ContextCompat.getColor(UtcCoinApplication.getAppContext(), R.color.my_blue);
    }

    public static Typeface GetTypeface() {
        if (typefaceLatoLight == null) init(UtcCoinApplication.getAppContext());
    ...
    public static String GetTodayViewTitle(int fragmentPosition) {
        return UtcCoinApplication.getAppContext().getString(TODAY_VIEW_TITLE[fragmentPosition]);
    }
    ...
    public static String GetAxisDateName(int type, int position) {
        switch (type) {
            ...
            case Calendar.DAY_OF_WEEK:
                if (WEEK_START_WITH_SUNDAY) return UtcCoinApplication.getAppContext().getResources()
                        .getString(WEEKDAY_SHORT_START_ON_SUNDAY[position + 1]);
                else return UtcCoinApplication.getAppContext().getResources()
                        .getString(WEEKDAY_SHORT_START_ON_MONDAY[position + 1]);
            case Calendar.DAY_OF_MONTH:
                return (position + 1) + "";
            case Calendar.MONTH:
                return UtcCoinApplication.getAppContext().getResources()
    ...
    public static String GetMonthShort(int i) {
        return UtcCoinApplication.getAppContext().getResources().getString(MONTHS_SHORT[i]);
    }

    public static String GetMonth(int i) {
        return UtcCoinApplication.getAppContext().getResources().getString(MONTHS[i]);
    }
    ...
    public static int GetTagColor(int tag) {
        return ContextCompat.getColor(UtcCoinApplication.getAppContext(), TAG_COLOR[tag + 3]);
    }

    public static Drawable GetTagDrawable(int tagId) {
        return ContextCompat.getDrawable(
                UtcCoinApplication.getAppContext(), TAG_DRAWABLE[tagId + 3]);
    }
    ...
    public static Drawable GetTagIconDrawable(int tagId) {
        return ContextCompat.getDrawable(
                UtcCoinApplication.getAppContext(), TAG_ICON[tagId + 2]);
    }

    public static String GetTagName(int tagId) {
        return UtcCoinApplication.getAppContext().getResources().getString(TAG_NAME[tagId + 2]);
    }
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = UtcCoinApplication.getAppContext()
                .getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = UtcCoinApplication.getAppContext()
    ...
    public static int dpToPx(int dp) {
        DisplayMetrics displayMetrics = UtcCoinApplication.getAppContext().getResources().getDisplayMetrics();
    ...
    public static String GetCurrentVersion() {
        return "UtcCoin V" + UtcCoinApplication.VERSION / 100 + "." + UtcCoinApplication.VERSION % 100 / 10 + "." + UtcCoinApplication.VERSION % 10;
    }
    ...
    public static String GetRecordDatabasePath(Context context) {
        ...
        if (BuildConfig.DEBUG) Log.d("UtcCoin", "Get record database path " + databasePath);
        return databasePath;
    }
...
//        if (file.exists()) file.delete();
    ...
    private static UtcCoinUtil ourInstance = new UtcCoinUtil();

    public static UtcCoinUtil getInstance() {
        if (ourInstance == null || typefaceLatoLight == null || typefaceLatoHairline == null) {
            ourInstance = new UtcCoinUtil();
            init(UtcCoinApplication.getAppContext());
        }
        return ourInstance;
    }
