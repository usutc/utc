...
public class DB {
    ...
    public static final String DB_NAME_STRING = "UtcCoin Database.db";
    ...
    public void getData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                if (BuildConfig.DEBUG) Log.d("UtcCoin Debugger", "Load " + coCoinRecord.toString() + " S");
    ...
    public long saveRecord(UtcCoinRecord coCoinRecord) {
        ...
        if (BuildConfig.DEBUG)
            Log.d("UtcCoin Debugger", "db.saveRecord " + coCoinRecord.toString() + " S");
        return insertId;
    }
    ...
    public int saveTag(Tag tag) {
        ...
        tag.setId(insertId);
        if (BuildConfig.DEBUG) Log.d("UtcCoin Debugger", "db.saveTag " + tag.toString() + " S");
        return insertId - 1;
    }
    ...
    public long deleteRecord(long id) {
        long deletedNumber = sqliteDatabase.delete(RECORD_DB_NAME_STRING,
                ...
                new String[]{id + ""});
        if (BuildConfig.DEBUG)
            Log.d("UtcCoin Debugger", "db.deleteRecord id = " + id + " S");
        if (BuildConfig.DEBUG)
            Log.d("UtcCoin Debugger", "db.deleteRecord number = " + deletedNumber + " S");
        return id;
    }
    ...
    public int deleteTag(int id) {
        int deletedNumber = sqliteDatabase.delete(TAG_DB_NAME_STRING,
                ...
                new String[]{(id + 1) + ""});
        if (BuildConfig.DEBUG)
            Log.d("UtcCoin Debugger", "db.deleteTag id = " + id + " S");
        if (BuildConfig.DEBUG)
            Log.d("UtcCoin Debugger", "db.deleteTag number = " + deletedNumber + " S");
        return id;
    }

    // return the id of the coCoinRecord update
    public long updateRecord(UtcCoinRecord coCoinRecord) {
        ContentValues values = new ContentValues();
        ...
        if (BuildConfig.DEBUG)
            Log.d("UtcCoin Debugger", "db.updateRecord " + coCoinRecord.toString() + " S");
    ...
    public int updateTag(Tag tag) {
        ...
        if (BuildConfig.DEBUG)
            Log.d("UtcCoin Debugger", "db.updateTag " + tag.toString() + " S");
        return tag.getId();
    }
    ...
    public int deleteAllRecords() {
        ...
        Log.d("UtcCoin Debugger", "db.deleteAllRecords " + deleteNum + " S");
        return deleteNum;
    }
}
